...
Features:
 ...
 - [Promisification filtros](https://github.com/petkaantonov/bluebird/blob/master/API.md#option-filter) are now passed `passesDefaultFilter` boolean
...
- Improve performance of catch filtros.
...
Bugfixes:
 ...
 - Support primitives in catch filtros
